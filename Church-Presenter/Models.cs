...
public sealed class PlannerComponent { public int Id { get; init; } public int Position { get; init; } public string Type { get; init; } = string.Empty; public string Title { get; init; } = string.Empty; public string Content { get; init; } = string.Empty; public string PresentationMode { get; init; } = "Static"; public string DisplayTitle => $"{Position + 1}. {Type}: {Title}"; }
